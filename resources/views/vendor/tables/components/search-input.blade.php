<div {{ $attributes->class(['filament-tables-search-input']) }}>
    ...
    <div class="relative group">
        ...
        <input wire:model.debounce.500ms="tableSearchQuery" id="tableSearchQueryInput"
            placeholder="{{ __('tables::table.fields.search_query.placeholder') }}" type="search" autocomplete="off"
            @class([
                'block w-full h-9 pl-9 placeholder-gray-400 transition duration-75 border-gray-300 shadow-sm focus:border-primary-600 focus:ring-1 focus:ring-inset focus:ring-primary-600',
