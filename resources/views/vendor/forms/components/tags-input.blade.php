...
>
    ...
    >
        <div
            ...
            @class([
                'block w-full transition duration-75 divide-y shadow-sm border overflow-hidden focus-within:border-primary-600 focus-within:ring-1 focus-within:ring-primary-600',
                ...
                <div class="flex flex-wrap gap-1">
                    <template class="hidden" x-for="tag in state" x-bind:key="tag">
                        <button
                            ...
                            @class([
                                'inline-flex items-center justify-center min-h-6 px-2 py-0.5 text-sm font-medium tracking-tight text-primary-700  bg-primary-500/10 space-x-1 rtl:space-x-reverse',
