    ...
    >
        @unless ($isDisabled())
            ...
            <trix-editor
                ...
                {{ $getExtraInputAttributeBag()->class([
                    'bg-white block w-full transition duration-75 shadow-sm focus:border-primary-500 focus:ring-1 focus:ring-inset focus:ring-primary-600 prose max-w-none',
        ...
        @else
            <div x-html="state" @class([
                'prose block w-full max-w-none border border-gray-300 bg-white p-3 opacity-70 shadow-sm',
