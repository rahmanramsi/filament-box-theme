    ...
    >
        ...
        <button
            ...
            {{ $getExtraTriggerAttributeBag()->class([
                'bg-white relative w-full border py-2 pl-3 pr-10 rtl:pl-10 rtl:pr-3 text-left cursor-default shadow-sm focus-within:border-primary-600 focus-within:ring-1 focus-within:ring-inset focus-within:ring-primary-600',
        ...
        @unless ($isDisabled())
            <div
                ...
                x-cloak
                @class([
                    'absolute z-10 my-1 bg-white border border-gray-300 shadow-md',
            ...
            >
                <div class="space-y-3">
                    ...
                    @if ($hasTime())
                        <div
                            @class([
                                'flex items-center justify-center bg-gray-50 py-2 rtl:flex-row-reverse',
