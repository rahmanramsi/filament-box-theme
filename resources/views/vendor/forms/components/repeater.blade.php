...
>
    ...
    <div {{ $attributes->merge($getExtraAttributes())->class([
        'space-y-6 filament-forms-repeater-component',
                ...
                >
                    @foreach ($containers as $uuid => $item)
                        <li
                            ...
                            @class([
                                'bg-white border border-gray-300 shadow-sm relative',
                        ...
                        >
                            @if ((! $isItemMovementDisabled) || (! $isItemDeletionDisabled) || $isCollapsible)
                                <header @class([
                                    'flex items-center h-10 overflow-hidden border-b bg-gray-50',
