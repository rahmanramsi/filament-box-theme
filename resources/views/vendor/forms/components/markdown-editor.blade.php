...
>
    ...
    >
        <div class="space-y-2">
            ...
            <div x-show="tab === 'edit'" class="relative w-full h-full" style="min-height: 150px;">
                <file-attachment directory>
                    <textarea
                        ...
                        @endif
                        @class([
                            'tracking-normal whitespace-pre-wrap overflow-y-hidden font-mono block absolute bg-transparent top-0 text-sm left-0 block z-1 w-full h-full min-h-full resize-none transition duration-75 shadow-sm focus:border-primary-500 focus:ring-1 focus:ring-inset focus:ring-primary-600 caret-black',
                ...
                <div
                    ...
                    @class([
                        'w-full h-full px-3 py-2 border border-transparent font-mono tracking-normal bg-white text-sm text-gray-900 break-words whitespace-pre-wrap',
            ...
            <div @class([
                'block w-full h-full min-h-full px-3 py-2 bg-white border border-gray-300 shadow-sm focus:border-primary-300',
                'dark:bg-gray-700 dark:border-gray-600' => config('forms.dark_mode'),
            ]) x-show="tab === 'preview'" x-cloak style="min-height: 150px;">
                <div @class([
                    'prose block w-full max-w-none border border-gray-300 bg-white p-3 shadow-sm',
