        ...
        >
            <input
                ...
                {{ $getExtraInputAttributeBag()->class([
                    'text-gray-900 block w-full transition duration-75 shadow-sm focus:border-primary-600 focus:ring-1 focus:ring-inset focus:ring-primary-600 disabled:opacity-70',
            ...
            >
                <span
                    ...
                    class="relative overflow-hidden w-7 h-7 filament-forms-color-picker-component-preview"
                ></span>
            </span>
