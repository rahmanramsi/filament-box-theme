...
<li class="filament-sidebar-item">
    <a
        ...
        @endif
        @class([
            'flex items-center justify-center gap-3 px-3 py-2 font-medium transition',
    ...
    >
        ...
        >
            ...
            @if (filled($badge))
                <span
                    @class([
                        'inline-flex items-center justify-center ml-auto rtl:ml-0 rtl:mr-auto min-h-4 px-2 py-0.5 text-xs font-medium tracking-tight whitespace-normal',
